...
This is the mapsvg library, HOWEVER it has been modified in a number of places to provide the functionality needed

To find modified parts search for 'sfs'
...
(function( $ ) {
    ...
    Region.prototype.setFill = function(fill){
        ...
        */
        ...
        if (countries[this.id]) {
            this.selected_attr['fill'] = countries[this.id].active_fill
            this.hover_attr['fill'] = countries[this.id].active_fill//tinycolor(this.default_attr.fill).lighten(parseFloat(this.globalOptions.colors.hover)).toRgbString();
        }
        else {
            this.selected_attr['fill'] = this.globalOptions.colors.selected;
            this.hover_attr['fill'] = tinycolor(this.default_attr.fill).lighten(parseFloat(this.globalOptions.colors.hover)).toRgbString();
    ...
    var defaults = {
        ...
        beforeLoad          : null,
        afterLoad           : null,
        zoom                : {on :false, limit: [0,10], delta: 1.2, buttons: {on: false, location: 'off'}, mousewheel: true},
    ...
    mapSVG = function(elem, options){
        ...
        this.methods = {
            ...
            setZoomButtons : function(){
                ...
                if (_data.options.zoom.buttons.on) {
...
//                _data.markerGroups[group].push(marker);
            ...
            scrollEnd : function (e,mapsvg){
                ...
                if (Math.abs(_data.scroll.dx)<5 && Math.abs(_data.scroll.dy)<5){
                    ...
                    // SFS MODIFIED
                        ...
                        if (_data.options.onDisabledClick) _data.options.onDisabledClick();
                    }
                    // END SFS MODIFIED
            ...
            init: function(opts, elem) {
                ...
                _data.options.onDisabledClick = options.onDisabledClick || null
